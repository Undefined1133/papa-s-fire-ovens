...
import { getProductTypeBySlug, getCategoryBySlug } from "@/data/products";
        ...
        <section className="py-12 bg-gradient-dark">
          <div className="container mx-auto px-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {productType.works.map((work) => (
                <Link
                  key={work.id}
                  to={`/catalog/${categorySlug}/${productTypeSlug}/${work.slug}`}
                ...
                >
                  ...
                  <div className="relative aspect-square overflow-hidden">
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6">
                      ...
                      {/* Hover Action */}
                      <div className="mt-3 flex items-center gap-2 text-primary font-medium opacity-0 group-hover:opacity-100 transform translate-y-2 group-hover:translate-y-0 transition-all duration-300">
